...
// $Id: main.php,v 1.1 2006/03/28 04:08:14 mikhail Exp $

// English version.

// Cat/artigo listing index.
define('_MD_CATLIST_CAPTION', 'artigos');            // Caption of category/artigo list
define('_MD_INDEX_PAGE_TITLE', 'Index page title');    // Title of category/artigo list page (not used in shipped package)
define('_MD_ARTIGO_VIEW_CAP', 'views');                // Caption for number of views
